...
<body>
    ...
    <div class="content">
		...
		<form action="orderSubmit" name="orderForm" method="post">
    		...
    		<div class="centerTop">
    			...
    			<ul class="adres">
					<c:forEach items="${shopAddressList }" var="shopAddress">
						<li>
			    			<input type="radio" name="shipAddId" value="${shopAddress.id }" style="width:50px">
			    			${shopAddress.receiveName }&nbsp;&nbsp;&nbsp;${shopAddress.phone }&nbsp;&nbsp;&nbsp;${shopAddress.address }
			    		</li>
					</c:forEach>
			    		<!-- <li>
    			...
    			<div class="twoDiv">
    				...
    				<ul class="oneUL">
    					<li>
    						...
    						<p><font>¥${orderLine.book.price }</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;×1&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;有货</p>
