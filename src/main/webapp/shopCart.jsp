...
<div class="empty">
	...
	<div class="mainCenter">
		...
		<div class="mainPro">
			...
			<c:forEach items="${shopCar.orderLines }" var="orderLine" varStatus="status">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="index2">
                                ...
                                <input type="hidden" value="${orderLine.book.id }" name="bookId">
                                <span>有货</span>
                            </td>
                            <td>
                            ...
                            <td>
                                <button>更新</button>
                                <button><a href="deleteOrderLineFromShopCar?bookId=${orderLine.book.id}">删除</a></button>
                            </td>
                        </tr>
                    </tbody>
                </table>
 ...
 -->
             <!-- <div class="bb">
                ...
                <div class="allButtom">
                    ...
                    <span>已选择<font>${shopCar.size }</font>件商品&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;总价(不含运费)：<font>¥${shopCar.cost }元</font></span>
                </div>
